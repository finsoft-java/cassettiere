...
import { ListBean, ValueBean, UbicazioniArticoli, Articolo } from '../_models';
...
export class UbicazioniArticoliService implements HttpCrudService<UbicazioniArticoli> {
  ...
  delete(obj: any): Observable<void> {
    return this.http.delete<void>(environment.wsUrl
              + `UbicazioniArticoli.php?COD_UBICAZIONE=${obj.COD_UBICAZIONE}&COD_ARTICOLO=${obj.COD_ARTICOLO}`);
  }
}
